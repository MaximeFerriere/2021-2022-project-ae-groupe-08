 ...
 */
 ...
 const GivenOfferList = async () => {
   ...
   try {
     ...
     const response = await fetch("/api/objects/givenOffers", options); // fetch return a promise => we wait for the response
