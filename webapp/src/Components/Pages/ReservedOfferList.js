 ...
 */
 ...
 const ReservedOfferList = async () => {
   ...
   try {
     ...
     const response = await fetch("/api/objects/reservedOffers", options); // fetch return a promise => we wait for the response
 ...
 export default ReservedOfferList;
